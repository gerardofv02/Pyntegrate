...
db = gffutils.FeatureDB(path + "/metaseq-example/data/Homo_sapiens.GRCh37.66_chr17.gtf.db")
...
ip_signal = Pyntegrate.genomic_signal(
    path + "/metaseq-example/data/wgEncodeHaibTfbsK562Atf3V0416101AlnRep1_chr17.bam",
    'bam')

print("\n\n\n\n\n\n\n\n\n",ip_signal)

input_signal = Pyntegrate.genomic_signal(
    path + "/metaseq-example/data/wgEncodeHaibTfbsK562RxlchV0416101AlnRep1_chr17.bam",
    'bam')
...
# # the Pyntegrate.plotutils.imshow function does a lot of work,
...
# ind, breaks = Pyntegrate.plotutils.new_clustered_sortind(
